...
Quick Start
    ...
    Verify all agents have fractal frontmatter:
    bash
...
Acknowledgments
    ...
    DeepSeek — The sovereign AI platform. github.com/deepseek-ai

    myICOR / myPKA — The agent scaffold. github.com/myICOR/myPKA
